...
1. --CHECKING THE DATA--
 ...
 2. --DOING SOME DATA CLEANING, BY CHCECKING FOR NULL VALUES--
...
--PERFORMING SOME ANALYSIS AND INSHIGHT ON THE MARKET TABLE
--BY Filtering, Grouping, Aggregate functions, Conditional, Wondow Functions--
...
FROM market
GROUP BY branch;
--The total sales revenue by branch is:
--A:  106200.3705000001
--B:  106197.67199999996
--C:  110568.70649999994 
8.--WHAT IS THE TOTAL SALES REVENUE BY PRODUCT LINE and THE AVG PRICE FOR EACH PRODUCT LINE?
...
b.--WHAT IF A CUSTOMER/CLIENT WANTS TO UPDATE THEIR PAYMENT METHOD FROM Ewallet TO Credit Card ?
...
b.--Determing the total tax amount for each payment method, and categorizing them as "High" or "Low" based on the total tax amount--
SELECT payment,
